...
public class EjecutivoDeVentas extends Usuario {

    public EjecutivoDeVentas(String nombre, String apellidoPaterno, String apellidoMaterno, String fechaDeNacimiento, String ciudad, String estado, String curp, String direccion, String RFC, double salario, Rol rol, Sucursal sucursal, String sexo, String userName, String password) {
    ...
    public static void registerEjecutivo(Usuario usuarioActual) {
        ...
        if (RFCEjecutivo != null) {
            ...
            EjecutivoDeVentas newEjecutivoDeCuenta = new EjecutivoDeVentas(nameEjecutivo, fatherLastNameEjecutivo, motherLastNameEjecutivo,
    ...
    private static void modificarDatos(EjecutivoDeVentas ejecutivo, String modificarRFC) {
        Scanner leer = new Scanner(System.in);
        int opcionModificar;
    ...
    public static void eliminarEjecutivo(Usuario usuarioActual) {
        ...
        System.out.println("\nIngrese el RFC del ejecutivo a eliminar:");
        String buscarRFC = leer.nextLine();

        if (usuarioActual.getSucursal().equals(Sucursal.ACUEDUCTO)) {
            ArrayList<Usuario> ejecutivoAcueducto = Banco.usuariosAcueducto.get(Rol.EJECUTIVODECUENTA);
            ...
            ArrayList<Usuario> ejecutivoMadero = Banco.usuariosMadero.get(Rol.EJECUTIVODECUENTA);
