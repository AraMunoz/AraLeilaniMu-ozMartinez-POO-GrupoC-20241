...
import examen_unidad3_herencia.Tarjetas.EstadoSolicitud;
...
public class Usuario {
    ...
    private static boolean esAutorizado(Usuario usuarioActual){
        if (usuarioActual.getRol().equals(Rol.GERENTE) || usuarioActual.getRol().equals(Rol.EJECUTIVODECUENTA)){
            return true;
        } else {
            return false;
        }
    ...
    public static void aceptarSolicitud(Usuario usuarioActual) {
        ...
        for (SolicitudTarjetaCredito buscarSolicitud : Banco.listaSolicitudes) {
